...
const CORE_PRIMITIVES = [
  {
    ...
    desc: "Run many isolated claws from the same hub with factory-level concurrency groups, queueing, and lifecycle state.",
  },
  {
  ...
  },
  {
    ...
    desc: "Factories can start work from external events, manual inputs, or pipeline transitions, then re-enter the workflow when CI, review, or issue state changes.",
  },
  {
    title: "Plugin-based extensions",
    desc: "Attach MCP servers, secrets, model providers, issue trackers, sandbox providers, and template files to each class of work.",
  },
  {
    title: "Local-first operation",
    desc: "Run the hub yourself. Keep configuration, templates, factories, credentials, and workflow state under your control.",
  },
  {
...
const WORKFLOWS = [
  ...
  {
    title: "Dependency upgrade factory",
  ...
  },
  {
    ...
    desc: "Compose longer workflows from staged instructions, templates, tools, secrets, and provider-backed execution environments.",
  },
];
...
const TERMINAL_LINES = [
  ...
  "$ elasticclaw factory create --name ci-repair --integration github-issues",
  "$ elasticclaw factory push ci-repair",
];
            ...
            <div className="space-y-5">
              <div className="rounded-lg border border-zinc-800 bg-zinc-950 shadow-2xl">
                ...
                <div className="space-y-4 p-5 font-mono text-sm leading-6">
                  <p className="text-zinc-500">factory.yaml</p>
                  <pre className="overflow-x-auto text-zinc-300">
                    <code>{`integration: github-issues
concurrency_group: ci-repair
template: node-service
pipeline: repair-and-review
secret_refs:
          ...
          <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.82fr_1.18fr] lg:items-start">
            ...
            <div className="space-y-5 text-lg leading-8 text-zinc-400">
              ...
              <p>
                ...
                factories that coordinate workers, delegate work, retry
        ...
        <section className="border-y border-zinc-800/80 bg-zinc-900/30 py-20">
          <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.86fr_1.14fr]">
            <div>
              ...
              <h2 className="text-3xl font-black tracking-tight text-white md:text-5xl">
                Build the factory. Don't rent the assistant.
              </h2>
              <p className="mt-5 leading-8 text-zinc-400">
                ElasticClaw gives you the runtime primitives to build your own
                software factory. Define the workstream, choose the provider,
