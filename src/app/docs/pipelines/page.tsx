...
export default function PipelinesPage() {
  return (
    ...
    >
      <Section title="What is a pipeline?">
        ...
        <p>
          When you run <code className="text-cyan-300">elasticclaw workspace create</code>, a
          default <code>pipeline.yaml</code> is generated alongside <code>workflow.yaml</code>.
        </p>
      </Section>
  ...
  - id: closed_no_merge
    ...
    on_enter:
      ...
      <Section title="Workspace variables">
        <p>
          <code>inject</code> messages and mapped <code>move_issue.issue_id</code>{" "}
          values can use Go workspace variables. Automatic issue-triggered
      ...
      <Section title="Default pipeline">
        <p>
          The default pipeline generated by <code>elasticclaw workspace create</code> has four stages:
        </p>
      ...
      <Note>
        Pipelines are pushed to the hub alongside workflows. Edit <code>pipeline.yaml</code>
        in your workspace directory, then run <code>elasticclaw workspace push</code>.
      </Note>
    </DocsPage>
  );
}
