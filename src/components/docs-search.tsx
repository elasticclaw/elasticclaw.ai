...
const DOCS_INDEX: SearchDoc[] = [
  ...
  { title: "CLI Reference", href: "/docs/cli-reference", excerpt: "All elasticclaw commands: create, chat, kill, workflow, workspace, hub.", tags: ["cli", "commands", "reference"] },
  ...
  { title: "Hub Config", href: "/docs/hub", excerpt: "hub.yaml reference — providers, LLM keys, GitHub Apps, MCP servers, auth, and secrets.", tags: ["config", "yaml", "hub"] },
  { title: "Providers", href: "/docs/providers", excerpt: "Sandbox providers: Daytona, Replicated CMX, and exe.dev.", tags: ["providers", "daytona", "cmx", "sandbox"] },
  ...
  { title: "Workflows", href: "/docs/workflows", excerpt: "Run software workflows from issue trackers, webhooks, releases, and other events.", tags: ["workflows", "automation", "linear", "github", "webhooks", "releases", "triggers"] },
  ...
  { title: "GitHub App", href: "/docs/github-integration", excerpt: "GitHub App installation for PRs, CI, and app workflows.", tags: ["github", "app", "pr", "ci"] },
  ...
  { title: "exe.dev Setup", href: "/docs/exe-dev", excerpt: "Provision persistent VMs with SSH access using exe.dev.", tags: ["exedev", "exe.dev", "provider", "ssh"] },
