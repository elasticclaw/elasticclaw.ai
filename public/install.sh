...
echo "GitHub: https://github.com/elasticclaw/elasticclaw"
echo ""
echo "If ElasticClaw looks useful, a GitHub star helps other developers find it."
echo "Trying it for launch? Tag @elasticclaw on X or send feedback to marc@elasticclaw.ai."
echo ""
if [[ "$OS" == "darwin" ]]; then
